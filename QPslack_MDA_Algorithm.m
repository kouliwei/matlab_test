...
slack_W = 0.0001; F_W = 1;
H = diag([slack_W slack_W slack_W F_W F_W F_W F_W]);
lb= [-inf;-inf;-inf;-40;-40;-40;-40];
ub=[inf;inf;inf;40;40;40;40];
B1 = [eye(3) B];
f=[];
...
for i=1:1000
    ...
    T = [10 + 5*rand(1); 20+ 20*rand(1);5 + 1*rand(1)];
    Tu = [Tu T(1)];
    Tw = [Tw T(2)];
    Tr = [Tr T(3)];
